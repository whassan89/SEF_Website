  ...
  return (
    <section className="py-16 bg-accent">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
        ...
        <Link
          href="/donate"
          className="inline-flex items-center gap-2 bg-white text-accent-dark hover:bg-accent-subtle font-bold px-10 py-4 rounded-xl text-lg transition-colors shadow-lg"
        >
